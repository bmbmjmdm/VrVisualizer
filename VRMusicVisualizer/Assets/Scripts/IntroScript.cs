...
public class IntroScript : MonoBehaviour
{
    ...
    void Update()
    {
      ...
      if (IntroProgress.needsMusic) {
        if (hasBeat) {
          ...
          text.text = "Welcome! First, turn on some music using a seperate program. I'll pick it up from your speakers!";
        }
      }
      ...
      // used left trigger again, they're on the custom screen, now needs to use button 1
        ...
        text.text = "Here you can add/subtract effects to make your own environment. Press the " + getCycleAddButton() + " to cycle through effects! (You can also refer to the images behind you)";
      }
    ...
    string getCycleAddButton() {
      if (controller_type == "knuckles") {
        ...
        return "UNSUPPORTED (refer to image behind you)";
      }
    }
